...
int NanoDet::detect(cv::Mat& rgb)
{
    ...
    std::vector<Object> objects;
    {
        ...
        { // stride 8
            ...
            __android_log_print(ANDROID_LOG_DEBUG, "yolop-opt", "stride 8 out shape: (%d,%d,%d), object8 num: %d\n", out.c, out.h, out.w, objects8.size());
        ...
        { // stride 16
            ...
            __android_log_print(ANDROID_LOG_DEBUG, "yolop-opt", "stride 16 out shape: (%d,%d,%d), object16 num: %d\n", out.c, out.h, out.w, objects16.size());
        ...
        { // stride 32
            ...
            __android_log_print(ANDROID_LOG_DEBUG, "yolop-opt", "stride 32 out shape: (%d,%d,%d), object32 num: %d\n", out.c, out.h, out.w, objects32.size());
...

        {
            ...
            __android_log_print(ANDROID_LOG_DEBUG, "yolop-opt", "da out shape : (%d, %d, %d)\n", da.c, da.h,da.w);
            __android_log_print(ANDROID_LOG_DEBUG, "yolop-opt", "ll out shape : (%d, %d, %d)\n", ll.c, ll.h,ll.w);
    ...
    __android_log_print(ANDROID_LOG_ERROR, "Detect","Draw");
